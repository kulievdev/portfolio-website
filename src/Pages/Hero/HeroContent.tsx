...
const HeroContent = () => {
  return (
    ...
    >
      ...
      >
        <p className="largeTablet:text-start text-center text-4xl font-bold leading-10 sm:text-5xl sm:font-extrabold sm:leading-[68px] desktop:text-7xl desktop:leading-[84px]">
          Hello, I'm Tohir, a{" "}
        ...
        <p className="largeTablet:text-start text-center text-lg font-medium leading-normal text-gray-600 sm:text-xl desktop:leading-7">
          Presenting unique and creative web solutions for a variety of
          challenges and needs.
        </p>
      </motion.header>
      <motion.nav
        className="largeTablet:justify-start inline-flex w-full items-start items-center justify-center space-x-4 desktop:space-x-8"
        initial={{ opacity: 0, y: 40, scale: 0.9, x: "-10%" }}
        animate={{ opacity: 1, y: 0, scale: 1, x: 0 }}
        transition={{ duration: 0.6 }}
      >
