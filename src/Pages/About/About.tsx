...
const About = () => {
    ...
    return (
        ...
        <section className="section_container relative flex flex-col justify-center">
            <p className="text-center mb-6 font-semibold">Get To Know More</p>
            ...
            <div className="flex flex-col items-center">
                ...
                <div>
                    <p className="text-gray-800 text-xl">
                        ...
                        embracing change and following my passions. Originally,
                        I was on track for a career in law—got admitted to law
                        schools and all. But as I delved deeper into legal
                        world, I realized my heart wasn't in it. Instead, I
                        found myself drawn to the exciting world of technology.
                        The endless possibilities fascinated me, so I made a big
                        decision to switch gears. 💡 That's when I jumped into
                        software engineering and enrolled in a software
                        engineering bootcamp, where I immersed myself in
                        learning the ins and outs of software development. Now?
                        Well,{" "}
                        {learnMore ? (
