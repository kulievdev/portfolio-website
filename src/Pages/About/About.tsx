                    ...
                    <div className="flex justify-center flex-col">
                        ...
                        <div>
                            <p className="text-gray-800">
                                ...
                                career in law—got admitted to law schools and
                                all. But as I delved deeper into legal world, I
                                realized my heart wasn't in it. Instead, I found
                                myself drawn to the exciting world of
                                technology. The endless possibilities fascinated
                                me, so I made a big decision to switch gears. 💡
                                That's when I jumped into software engineering
                                and enrolled in a software engineering bootcamp,
                                where I immersed myself in learning the ins and
                                outs of software development. Now? Well,{" "}
                                {learnMore ? (
