...
const TechStack = () => {
  return (
    <section className="relative bg-gradient-to-br from-primary-50 to-gray-50">
      <div className="section_container xs:h-[110vh] s:h-[100vh] xs:mx-6 iPhone14:h-[120vh] relative mx-4 flex h-[140vh] flex-col justify-center md:mx-10 lg:mx-20 laptop:h-[140vh] desktop:mx-0 desktop:h-[100vh]">
