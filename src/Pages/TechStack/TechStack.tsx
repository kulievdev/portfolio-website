  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-50 to-gray-50">
      <div className="section_container relative mx-6 my-0  flex h-fit flex-col justify-center py-20 sm:mx-10 lg:mx-14 desktop:h-[100vh] desktop:py-0">
        <p className="mb-4 text-center text-sm font-semibold sm:text-xl desktop:mb-6">
          Explore My
        </p>
        ...
        <div className="sm:block sm:gap-0">
          <div className=" xs:justify-center mb-10 flex flex-row gap-8 sm:flex sm:flex-col sm:justify-center sm:gap-10 desktop:flex desktop:flex-row desktop:gap-20">
