    ...
    <>
      {(() => {
        switch (type) {
          ...
          case "project cta":
            return (
              <button className="w-[8rem] rounded-xl border-2 border-gray-300 px-6 py-2 text-sm font-semibold text-gray-700 transition-colors duration-300 ease-linear hover:border-gray-700 hover:bg-gray-700 hover:text-white desktop:text-lg ">
                {projectCtaText}
              </button>
            );
          default:
