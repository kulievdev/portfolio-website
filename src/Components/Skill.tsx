...
const Skill: React.FC<SkillProps> = ({ imgSrc, name }) => {
  return (
    <div className="flex transform cursor-pointer flex-col items-center transition duration-300 ease-in hover:translate-x-4 sm:hover:-translate-y-4 sm:hover:translate-x-0">
      <img
        src={imgSrc}
